...
const I18N = {
  de: {
    ...
    field_telemetry_enabled: "Anonyme Nutzungsstatistik senden",
    telemetry_hint: "Sendet alle 10s ein anonymes Heartbeat-Signal (keine Discord-Identität, nur eine zufällige Geräte-ID) — zeigt im DevHub-Bot-Profil, wie viele Instanzen gerade laufen. Kein Einfluss auf die Funktion von DevHub, wenn deaktiviert.",
    field_feedback_text: "Feedback",
    field_feedback_placeholder: "Bug gefunden? Idee für ein Feature? Schreib's hier rein...",
    send_feedback: "FEEDBACK SENDEN",
    feedback_hint: "Landet direkt im Discord-Feedback-Kanal des DevHub-Teams.",
    feedback_empty: "Bitte einen Text eingeben.",
    feedback_sent: "✅ Danke! Feedback wurde gesendet.",
    feedback_failed: "Senden fehlgeschlagen — Telemetrie-Server evtl. offline.",
  },
  en: {
    subtitle: "// CYBER COMMAND CENTER",
    ...
    tab_feedback: "FEEDBACK",
    field_telemetry_enabled: "Send anonymous usage stats",
    telemetry_hint: "Sends an anonymous heartbeat every 10s (no Discord identity, just a random device ID) — shows the DevHub bot profile how many instances are currently running. No effect on DevHub's functionality if disabled.",
    field_feedback_text: "Feedback",
    field_feedback_placeholder: "Found a bug? Have a feature idea? Write it here...",
    send_feedback: "SEND FEEDBACK",
    feedback_hint: "Goes straight to the DevHub team's Discord feedback channel.",
    feedback_empty: "Please enter some text.",
    feedback_sent: "✅ Thanks! Feedback sent.",
    feedback_failed: "Failed to send — telemetry server might be offline.",
  },
};
