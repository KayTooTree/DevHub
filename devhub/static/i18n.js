...
const I18N = {
  de: {
    ...
    tab_account: "DISCORD-KONTO",
    tab_discord_rpc: "DISCORD RPC",
    account_hint: "Verknüpfe DevHub mit deinem Discord-Account — dein Discord-Anzeigename und Profilbild werden dann automatisch übernommen, statt dass du sie manuell einträgst.",
    link_discord: "MIT DISCORD VERKNÜPFEN",
    generating_code: "Code wird generiert...",
    verify_instructions: "Tipp in einem Discord-Server mit dem DevHub Bot: <code>/verify CODE</code>",
    waiting_for_verify: "Warte auf Bestätigung...",
    account_linked_hint: "Dein Discord-Anzeigename wird jetzt automatisch als Operator-Name verwendet.",
    unlink_account: "VERKNÜPFUNG TRENNEN",
    panel_connections: "AKTIVE VERBINDUNGEN",
    th_local: "LOKAL",
    th_remote: "REMOTE",
    no_connections: "Keine aktiven Verbindungen",
    panel_devtools: "DEV TOOLS",
    copied: "KOPIERT!",
    dt_input: "Eingabe",
    dt_output: "Ausgabe",
    dt_encode: "ENCODE",
    ...
    dt_copy: "KOPIEREN",
    dt_error: "Fehler",
    dt_invalid_base64: "Ungültiges Base64",
    dt_format: "FORMATIEREN",
    dt_minify: "MINIFIZIEREN",
    dt_invalid_json: "Ungültiges JSON",
    dt_generate: "GENERIEREN",
    dt_hash_hint: "Läuft komplett lokal im Browser (Web Crypto API) — nichts wird irgendwohin gesendet.",
    dt_uuid_count: "Anzahl",
    dt_copy_all: "ALLE KOPIEREN",
    dt_unix_timestamp: "Unix-Timestamp",
    dt_now: "JETZT",
    dt_convert: "KONVERTIEREN",
    dt_local_time: "Lokale Zeit",
    dt_ts_hint: "Erkennt automatisch Sekunden vs. Millisekunden anhand der Ziffernanzahl.",
    dt_color_hex: "Hex-Farbe",
    panel_cheatsheet: "CHEAT SHEET",
    cheatsheet_search_placeholder: "Suchen (z.B. 'git', 'docker', 'rebase')...",
    cheatsheet_no_results: "Keine Treffer.",
  },
  en: {
    subtitle: "// CYBER COMMAND CENTER",
    ...
    tab_account: "DISCORD ACCOUNT",
    tab_discord_rpc: "DISCORD RPC",
    account_hint: "Link DevHub to your Discord account — your Discord display name and avatar will then be used automatically instead of setting them manually.",
    link_discord: "LINK DISCORD ACCOUNT",
    generating_code: "Generating code...",
    verify_instructions: "Type this in a Discord server with the DevHub bot: <code>/verify CODE</code>",
    waiting_for_verify: "Waiting for confirmation...",
    account_linked_hint: "Your Discord display name is now used as the operator name automatically.",
    unlink_account: "UNLINK ACCOUNT",
    panel_connections: "ACTIVE CONNECTIONS",
    th_local: "LOCAL",
    th_remote: "REMOTE",
    ...
    dt_copy: "COPY",
    dt_error: "Error",
    dt_invalid_base64: "Invalid Base64",
    dt_format: "FORMAT",
    dt_minify: "MINIFY",
    dt_invalid_json: "Invalid JSON",
    dt_generate: "GENERATE",
    dt_hash_hint: "Runs entirely in the browser (Web Crypto API) — nothing is sent anywhere.",
    dt_uuid_count: "Count",
    dt_copy_all: "COPY ALL",
    dt_unix_timestamp: "Unix timestamp",
    dt_now: "NOW",
    dt_convert: "CONVERT",
    dt_local_time: "Local time",
    dt_ts_hint: "Automatically detects seconds vs. milliseconds based on digit count.",
    dt_color_hex: "Hex color",
    panel_cheatsheet: "CHEAT SHEET",
    cheatsheet_search_placeholder: "Search (e.g. 'git', 'docker', 'rebase')...",
    cheatsheet_no_results: "No matches.",
  },
};
